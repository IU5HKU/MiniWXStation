...
void Send2APRS()
{
  ...
  sprintf(sentence, "%s>APRS,TCPIP*:=%s/%s&%s (SoftVer: %s)",station.callsign, 
                                                                 station.latitude, 
                                                                 station.longitude, 
                                                                 APRS_CMNT, SOFT_VER);
  ...
  sprintf(sentence, "%s>APRS,TCPIP*:@%02d%02d%02dh%s/%s_.../...g...t%03dr...p...P...h%02db%05d", station.callsign, 
                                                                                                             dateTime.hour, 
                                                                                                             dateTime.minute, 
                                                                                                             dateTime.second, 
                                                                                                             station.latitude, 
