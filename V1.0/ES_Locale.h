...
//* SPANISH LANGUAGE
//****************************************************
const char PAGE_Main_ES[] PROGMEM = "<!DOCTYPE html>\
<html>\
<head>\
...
function getData() {\
  ...
  <body>\
    <hr>\
    <h3 style='text-shadow: 2px 1px grey;'>{{callsign}} Estación Meteo - <a id='clock' class='tabheader' style='padding-right:10px'>{{time}}</a></h3>\
    <h4>\
    ...
    <div class='divTable'>\
      <div class='divRow'>\
        <div class='divColumn' style='width:50%'>\
          <div class='tabheader'>Parámetros</div>\
          <div class='notabheader'>Temperatura</div>\
          <div class='notabheader'>Presión</div>\
          <div class='notabheader'>Humedad relativa</div>\
          <div class='notabheader'>Punto de rocío</div>\
          <div class='notabheader'>Sensación térmica</div>\
        </div>\
        ...
        <div class='divColumn' style='width:22%'>\
          <div class='tabheader'>Unidades</div>\
    ...
    <legend style='text-shadow: 2px 1px grey;'> Información del sistema </legend>\
      <div class='divTable'>\
          <div class='divRow'>\
            <div class='divColumn' style='width:28%'>\
              ...
              <div class='tabheader'>IP actual</div>\
    ...
    <form action='/submit' method='POST'>\
      <fieldset style='width:50%'>\
      <legend style='text-shadow: 2px 1px grey;'> Panel de Control </legend>\
      <div>\
...
//* SPANISH LANGUAGE
//***********************************************************
const char PAGE_MiniWXSettings_ES[] PROGMEM = "<!DOCTYPE html>\
<html>\
<head>\
<meta lang='es' http-equiv='Content-Type' content='text/html; charset=UTF-8'>\
    ...
    <form style='width:58%' action='/submit' method='POST'>\
        ...
        <div class='divTable'>\
          <div class='divRow'>\
            <div class='divColumn'>\
              <fieldset>\
              <legend><h2>APRS Configuración</h2></legend>\
            ...
            <div class='divColumn'>\
              ...
              <legend><h2>Configuración IP estática</h2></legend>\
                <span>\
                  ...
                  <label>Usar IP estática (reinicio necesario)</label>\
                </span><p></p>\
                <label>IP</label>\
          ...
          <div class='divRow'>\
            <div class='divColumn'>\
              <fieldset>\
              <legend><h2>WUNDER Configuración</h2></legend>\
                <div>\
                  <span>\
