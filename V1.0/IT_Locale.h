...
//* ITALIAN LANGUAGE
//****************************************************
const char PAGE_Main_IT[] PROGMEM = "<!DOCTYPE html>\
<html>\
<head>\
<meta lang='it' http-equiv='Content-Type' content='text/html' charset='UTF-8'>\
...
function getData() {\
  ...
  <body>\
    <hr>\
    <h3 style='text-shadow: 2px 1px grey;'>{{callsign}} Stazione Meteo - <a id='clock' class='tabheader' style='padding-right:10px'>{{time}}</a></h3>\
    <h4>\
    <fieldset style='width:49%'>\
    <legend style='text-shadow: 2px 1px grey;'> Sensore {{ChipModel}} </legend>\
    <div class='divTable'>\
      <div class='divRow'>\
        <div class='divColumn' style='width:50%'>\
          <div class='tabheader'>Parametri</div>\
          <div class='notabheader'>Temperatura</div>\
          <div class='notabheader'>Pressione</div>\
          <div class='notabheader'>Umidità relativa</div>\
          <div class='notabheader'>Punto di rugiada</div>\
          <div class='notabheader'>Indice di calore</div>\
        </div>\
        <div class='divColumn' style='width:24%'>\
          <div class='tabheader'>Valori</div>\
      ...
      <div class='divTable'>\
          <div class='divRow'>\
            ...
            <div class='divColumn' style='width:68%'>\
              ...
              <div class='notabheader' style='color: silver;'>Lat: {{lat}} Long: {{long}} Alt: {{alt}}m slm</div>\
            </div>\
          </div>\
      </div>\
    </fieldset>\
    ...
    <form action='/submit' method='POST'>\
      <fieldset style='width:50%'>\
      <legend style='text-shadow: 2px 1px grey;'> Pannello di Controllo </legend>\
      <div>\
...
//* ITALIAN LANGUAGE
//***********************************************************
const char PAGE_MiniWXSettings_IT[] PROGMEM = "<!DOCTYPE html>\
<html>\
<head>\
<meta lang='it' http-equiv='Content-Type' content='text/html; charset=UTF-8'>\
<title>MiniWXConfiguración</title>\
</head>\
<style>\
    ...
    <form style='width:58%' action='/submit' method='POST'>\
        ...
        <div class='divTable'>\
          <div class='divRow'>\
            <div class='divColumn'>\
              <fieldset>\
              <legend><h2>Configurazione APRS</h2></legend>\
            ...
            <div class='divColumn'>\
              ...
              <legend><h2>Configurazione IP statico</h2></legend>\
                <span>\
                  ...
                  <label>USA IP STATICO (dopo riavvio)</label>\
                </span><p></p>\
                <label>IP</label>\
          ...
          <div class='divRow'>\
            <div class='divColumn'>\
              <fieldset>\
              <legend><h2>Configurazione WUNDER</h2></legend>\
                <div>\
                  <span>\
