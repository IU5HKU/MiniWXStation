...
//* GERMAN LANGUAGE
//* Translated by DL9SEC (20241020)
//***********************************************************
const char PAGE_Main_DE[] PROGMEM = "<!DOCTYPE html>\
<html>\
<head>\
<meta lang='en' http-equiv='Content-Type' content='text/html' charset='UTF-8'>\
<title>MiniWX Wetterstation</title>\
<style>\
...
function getData() {\
  ...
  <body>\
    <hr>\
    <h3 style='text-shadow: 2px 1px grey;'>{{callsign}} Wetterstation - <a id='clock' class='tabheader' style='padding-right:10px'>{{time}}</a></h3>\
    <h4>\
    ...
    <div class='divTable'>\
      <div class='divRow'>\
        <div class='divColumn' style='width:{{fieldsize1}}'>\
          ...
          <div class='notabheader'>Temperatur</div>\
          <div class='notabheader'>Luftdruck</div>\
          <div class='notabheader'>Relative Luftfeuchtigkeit</div>\
          <div class='notabheader'>Taupunkt</div>\
          <div class='notabheader'>W&auml;rmeindex</div>\
        </div>\
        <div class='divColumn' style='width:{{fieldsize2}}'>\
          <div class='tabheader'>Wert</div>\
        ...
        <div class='divColumn' style='width:{{fieldsize3}}'>\
          <div class='tabheader'>Einheit</div>\
      ...
      <div class='divTable'>\
          <div class='divRow'>\
            <div class='divColumn' style='width:{{fieldsize5}}'>\
              <div class='tabheader'>Betriebszeit</div>\
              <div class='tabheader'>N&auml;chstes TX</div>\
              <div class='tabheader'>SSID</div>\
              <div class='tabheader'>RSSI</div>\
              <div class='tabheader'>BSSID</div>\
              <div class='tabheader'>IP Adresse</div>\
            ...
            <div class='divColumn' style='width:{{fieldsize6}}'>\
              ...
              <div class='notabheader' style='color: silver;'>Lat: {{lat}} Lon: {{long}} Alt: {{alt}}m asl</div>\
            </div>\
          </div>\
      </div>\
    </fieldset>\
    ...
    <form action='/submit' method='POST'>\
      ...
      <legend style='text-shadow: 2px 1px grey;'> Steuerkonsole </legend>\
    ...
    <p>MiniWX Station&#8482; ({{SOFT_VER}}) - <a href='https://github.com/IU5HKU/MiniWXStation'>Hier</a> klicken und auf neueste Version pr&uuml;fen</p>\
    </h6>\
  </body>\
</html>";
...
//***********************************************************
const char PAGE_MiniWXSettings_DE[] PROGMEM = "<!DOCTYPE html>\
<html>\
<head>\
<meta  lang='en' http-equiv='Content-Type' content='text/html; charset=UTF-8'>\
<title>MiniWX Einstellungen</title>\
</head>\
<style>\
    ...
    <form style='width:58%' action='/submit' method='POST'>\
        ...
        <div class='divTable'>\
          <div class='divRow'>\
            <div class='divColumn'>\
              <fieldset>\
              <legend><h2>APRS-Einstellungen</h2></legend>\
            ...
            <div class='divColumn'>\
              ...
              <legend><h2>Einstellungen f&uuml;r statische IP </h2></legend>\
                <span>\
                  ...
                  <label>Statische IP verwenden (Neustart notwendig)</label>\
                </span><p></p>\
                <label>IP</label>\
          ...
          <div class='divRow'>\
            <div class='divColumn'>\
              <fieldset>\
              <legend><h2>WUNDER-Einstellungen</h2></legend>\
                <div>\
                  <span>\
