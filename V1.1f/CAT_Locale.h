    ...
    <div class='divTable'>\
      <div class='divRow'>\
        <div class='divColumn' style='width:{{fieldsize1}}'>\
          <div class='tabheader'>Paràmetres</div>\
          <div class='notabheader'>Temperatura</div>\
          <div class='notabheader'>Pressió atmosfèrica</div>\
          <div class='notabheader'>Humitat relativa</div>\
          <div class='notabheader'>Punt de rosada</div>\
          <div class='notabheader'>Índex de xafogor</div>\
        </div>\
        <div class='divColumn' style='width:{{fieldsize2}}'>\
          <div class='tabheader'>Unitat</div>\
      ...
      <div class='divTable'>\
          <div class='divRow'>\
            <div class='divColumn' style='width:{{fieldsize5}}'>\
              ...
              <div class='tabheader'>Xarxa Wifi</div>\
