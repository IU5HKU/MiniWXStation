...
//* TURKISH LANGUAGE
//***********************************************************
const char PAGE_Main_TR[] PROGMEM = "<!DOCTYPE html>\
<html>\
<head>\
<meta lang='TR' http-equiv='ContTRt-Type' content='text/html' charset='UTF-8'>\
<title>MiniWX Havadurumu İstasyonu</title>\
<style>\
...
function getData() {\
  ...
  <body>\
    <hr>\
    <h3 style='text-shadow: 2px 1px grey;'>{{callsign}} Havadurumu İstasyonu - <a id='clock' class='tabheader' style='padding-right:10px'>{{time}}</a></h3>\
    <h4>\
    ...
    <div class='divTable'>\
      <div class='divRow'>\
        <div class='divColumn' style='width:{{fieldsize1}}'>\
          <div class='tabheader'>Parametreler</div>\
          <div class='notabheader'>Sıcaklık</div>\
          <div class='notabheader'>Basınç</div>\
          <div class='notabheader'>Bağıl Nem</div>\
          <div class='notabheader'>Çiy Noktası</div>\
          <div class='notabheader'>Isı Endeksi</div>\
        </div>\
        <div class='divColumn' style='width:{{fieldsize2}}'>\
          <div class='tabheader'>Değer</div>\
    ...
    <legend style='text-shadow: 2px 1px grey;'> Sistem Bilgileri </legend>\
      <div class='divTable'>\
          <div class='divRow'>\
            <div class='divColumn' style='width:{{fieldsize5}}'>\
              <div class='tabheader'>Çalışma Süresi</div>\
              <div class='tabheader'>Sonraki TX</div>\
              <div class='tabheader'>SSID</div>\
              <div class='tabheader'>RSSI</div>\
              <div class='tabheader'>BSSID</div>\
              <div class='tabheader'>IP adres</div>\
              <div class='tabheader'>Pozisyon</div>\
            </div>\
    ...
    <form action='/submit' method='POST'>\
      ...
      <legend style='text-shadow: 2px 1px grey;'> Kontrol Panel </legend>\
    ...
    <p>MiniWX Station&#8482; ({{SOFT_VER}}) - En son versiyon için <a href='https://github.com/IU5HKU/MiniWXStation'>tıklayın</a> </p>\
    </h6>\
  </body>\
</html>";
...
//***********************************************************
const char PAGE_MiniWXSettings_TR[] PROGMEM = "<!DOCTYPE html>\
<html>\
<head>\
<meta  lang='TR' http-equiv='Content-Type' content='text/html; charset=UTF-8'>\
    ...
    <form style='width:58%' action='/submit' method='POST'>\
        ...
        <div class='divTable'>\
          <div class='divRow'>\
            <div class='divColumn'>\
              <fieldset>\
              <legend><h2>APRS Ayarları</h2></legend>\
                <label>Server Addres</label>\
            ...
            <div class='divColumn'>\
              ...
              <legend><h2>STATIC IP Ayarları</h2></legend>\
                <span>\
                  ...
                  <label>Static IP kullan (yeniden başlatma gerektirir)</label>\
                </span><p></p>\
                <label>IP</label>\
          ...
          <div class='divRow'>\
            <div class='divColumn'>\
              <fieldset>\
              <legend><h2>WUNDER Ayarları</h2></legend>\
                <div>\
                  <span>\
